...
# массиве), которых нет во втором массиве. Пользователь вводит число N - количество элементов в первом 
...
# print(f'Совпадаюшие элементы в масивах {i}')

# l = musA.difference(musB) 
# print(f'НЕ cовпадаюшие элементы в масивах {l}')

# Ответ
# Совпадаюшие элементы в масивах {1, 4}
# НЕ cовпадаюшие элементы в масивах {2, 3, 12}
