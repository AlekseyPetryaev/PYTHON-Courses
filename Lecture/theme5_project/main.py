"""
Создайте модуль main.py. Из модулей, реализованных в модулях folders.py и randomlist.py, сделайте импорт 
...
"""
при вызове функции в данном модуле в консоли выводятся результаты из модулей folders.py и randomlist.py,
т.к. в них мы вызываем функции, чтобы этого не происходило, для этого необходимо вывести выражение 
